...
class Plant(db.Model):
    ...
    name_plant = db.Column(db.String(50), nullable=False)
    min_humidity = db.Column(db.Float(), nullable=False)

    #sensors = db.relationship("Sensor",backref="plants",lazy=True)

    def insert_plant(id_plant,id_sensor,name_plant,min_humidity):
        
        plant =  Plant(id_plant=id_plant,id_sensor=id_sensor,name_plant=name_plant,min_humidity=min_humidity)
